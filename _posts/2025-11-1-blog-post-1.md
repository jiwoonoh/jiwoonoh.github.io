...
date: 2025-10-25
layout: single
permalink: /blog/2025/moe-health
header:
  teaser: /images/MOE-1.png
---
...
<img src="{{ "/images/MOE-1.png" | relative_url }}" width="800" height="800" />
...
<img src="{{ "/images/MOE-2.png" | relative_url }}" width="400" height="400" />
...
<img src="{{ "/images/MOE-3.png" | relative_url }}" width="400" height="400" />
...
<img src="{{ "/images/MOE-4.png" | relative_url }}" width="600" height="600" />
...
FuseMoE uses Laplace gating function to pick experts based on how "close" each expert is to the input. Specifically, their routing function is: $$h_\ell(x)_i = -\|x - W_i\|_2^2$$, with gate probabilities of $$G_\ell(x)_i = \frac{\exp(h_\ell(x)_i)}{\sum_{j=1}^S \exp(h_\ell(x)_j)}$$.
...
<img src="{{ "/images/MOE-5.png" | relative_url }}" width="600" height="600" />
...
<img src="{{ "/images/MOE-6.png" | relative_url }}" width="600" height="600" />
